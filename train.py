...
os.environ["WANDB_API_KEY"] = "ed2d672dab71a6d3f0a96f6816f028ea37d50ae8" # write your own wandb id
...
def parse_args(argv):
    ...
    # 数据集路径
    parser.add_argument(
        "-d", "--dataset", type=str, default='data/ldmic/cityscapes/', help="Training dataset"
    )
    # 数据集名称
    parser.add_argument(
...
def main(argv):
    ...
    if args.model_name == "LDMIC":
        ...
        net = LDMIC(N=64, M=64, decode_atten=JointContextTransfer)
    elif args.model_name == "LDMIC_VAE":
        net = LDMIC_VAE(N=96, M=192, decode_atten=JointContextTransfer)
